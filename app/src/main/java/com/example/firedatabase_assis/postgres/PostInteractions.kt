...
interface PostInteractions {
    ...
    suspend fun saveInteractionData(@Body interactionData: UserPostInteraction): Response<String>
    ...
    suspend fun getPostInteractionsByUser(@Path("userId") userId: Int): Response<List<UserPostInteraction>>

    @GET("/api/interactions/user/{userId}/post/{postId}")
    suspend fun getPostInteraction(
        @Path("userId") userId: Int,
        @Path("postId") postId: Int
    ): Response<UserPostInteraction>
